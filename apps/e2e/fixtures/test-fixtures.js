 ...
 * 清理测试用户
 */
async function cleanupTestUser(apiContext, userId) {
    try {
 ...
 * 创建测试Agent
 */
async function createTestAgent(apiContext, token) {
 ...
 * 清理测试Agent
 */
async function cleanupTestAgent(apiContext, token, agentId) {
    try {

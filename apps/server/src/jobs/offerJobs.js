 ...
 */
export async function checkExpiredOffersJob() {
    try {
 ...
 */
export async function activateScheduledOffersJob() {
    try {
 ...
 */
export async function checkLowStockOffersJob() {
    try {
 ...
 */
export async function runOfferMaintenanceJobs() {
...
//# sourceMappingURL=offerJobs.js.map
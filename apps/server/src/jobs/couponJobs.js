 ...
 */
export async function runCouponReminderJob() {
 ...
 * Should be scheduled to run every hour
 */
export async function runCouponExpirationJob() {
 ...
 */
export function initializeCouponJobs() {
...
//# sourceMappingURL=couponJobs.js.map
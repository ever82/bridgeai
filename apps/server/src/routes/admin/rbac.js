 ...
 */
router.get('/roles', requirePermission('rbac:read'), async (_req, res, next) => {
    try {
 ...
 * @access  Admin - rbac:read
 */
router.get('/roles/:roleId', requirePermission('rbac:read'), validateParams(roleIdSchema), async (req, res, next) => {
    try {
 ...
 */
router.post('/roles', requirePermission('rbac:write'), validateBody(createRoleSchema), async (req, res, next) => {
    try {
 ...
 * @access  Admin - rbac:write
 */
router.put('/roles/:roleId', requirePermission('rbac:write'), validateParams(roleIdSchema), validateBody(updateRoleSchema), async (req, res, next) => {
    try {
        const { roleId } = req.params;
        const role = await rbacService.getRoleById(roleId);
        if (!role) {
 ...
 * @access  Admin - rbac:write
 */
router.delete('/roles/:roleId', requirePermission('rbac:write'), validateParams(roleIdSchema), async (req, res, next) => {
    try {
        const { roleId } = req.params;
 ...
 * @access  Admin - rbac:read
 */
router.get('/permissions', requirePermission('rbac:read'), async (_req, res, next) => {
    try {
 ...
 * @access  Admin - rbac:read
 */
router.get('/users/:userId/roles', requirePermission('rbac:read'), validateParams(userIdSchema), async (req, res, next) => {
    try {
 ...
 * @access  Admin - rbac:read
 */
router.get('/users/:userId/permissions', requirePermission('rbac:read'), validateParams(userIdSchema), async (req, res, next) => {
    try {
        const { userId } = req.params;
 ...
 * @access  Admin - rbac:write
 */
router.post('/assign-role', requirePermission('rbac:write'), validateBody(assignRoleSchema), async (req, res, next) => {
    try {
 ...
 * @access  Admin - rbac:write
 */
router.post('/remove-role', requirePermission('rbac:write'), validateBody(removeRoleSchema), async (req, res, next) => {
    try {
 ...
 */
router.post('/initialize', requireRole('super_admin'), async (_req, res, next) => {
    try {
 ...
 * @access  Admin - rbac:read
 */
router.get('/check/:userId/:permission', requirePermission('rbac:read'), async (req, res, next) => {
    try {

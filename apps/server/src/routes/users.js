 ...
 * @access Private
 */
router.put('/me', authenticate, validateBody(updateProfileSchema), asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
 ...
 * @access Private
 */
router.post('/avatar', authenticate, avatarUpload.single('avatar'), handleUploadError, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
 ...
 * @access Private
 */
router.get('/privacy', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
 ...
 * @access Private
 */
router.put('/privacy', authenticate, validateBody(privacySettingsSchema), asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }

 ...
 * @access  Private
 */
router.post('/chat', authenticateToken, validate(chatCompletionSchema), async (req, res) => {
    try {
        await ensureService();
 ...
 * @access  Private
 */
router.post('/embeddings', authenticateToken, validate(embeddingSchema), async (req, res) => {
    try {
        await ensureService();
 ...
 */
router.post('/routing/strategy', authenticateToken, async (req, res) => {
    try {
        ...
        llmService.setRoutingStrategy(strategy);
        res.json({
            success: true,
            data: { strategy }
        });

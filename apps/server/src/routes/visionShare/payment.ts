 ...
 * Verify payment password
 */
router.post('/verify-password', authenticate, async (req: Request, res: Response) => {
  try {
    const userId = req.user!.id;
 ...
 */
router.get('/confirmation/:id', authenticate, async (req: Request, res: Response) => {
  try {
    const transactionId = req.params.id;
 ...
 */
router.get('/photos/:photoId/unlock-status', authenticate, async (req: Request, res: Response) => {
  try {
    const userId = req.user!.id;
 ...
 */
router.post('/photos/download/:token', authenticate, async (req: Request, res: Response) => {
  try {
    const userId = req.user!.id;

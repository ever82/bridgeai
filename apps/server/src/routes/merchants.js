...
router.post('/', authenticate, asyncHandler(async (req, res) => {
    ...
    const { agentId, name, address, phone, businessHours, description, logoUrl, category } = req.body;
    if (!agentId || !name) {
...
router.put('/:id', authenticate, asyncHandler(async (req, res) => {
    ...
    const { id } = req.params;
    const { name, address, phone, businessHours, description, logoUrl, category, status } = req.body;

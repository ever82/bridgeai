 ...
 * @access Private
 */
router.post('/agents/consumer', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
 ...
 * @access Private
 */
router.get('/agents/consumer/:agentId', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
 ...
 * @access Private
 */
router.put('/agents/consumer/:agentId/categories', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { agentId } = req.params;
 ...
 * @access Private
 */
router.put('/agents/consumer/:agentId/budget', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { agentId } = req.params;
 ...
 * @access Private
 */
router.put('/agents/consumer/:agentId/preferences', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { agentId } = req.params;
 ...
 * @access Private
 */
router.put('/agents/consumer/:agentId/timeline', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { agentId } = req.params;
 ...
 * @access Private
 */
router.put('/agents/consumer/:agentId/location', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { agentId } = req.params;
 ...
 * @access Private
 */
router.post('/agents/consumer/:agentId/ai-extract', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { agentId } = req.params;
    ...
    const agent = await consumerDemandService.applyAIExtractedData(agentId, req.user.id, extractedData);
 ...
 * @access Private
 */
router.get('/agents/consumer/:agentId/preview', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { agentId } = req.params;
 ...
 * @access Private
 */
router.post('/agents/consumer/:agentId/publish', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { agentId } = req.params;
 ...
 * @access Private
 */
router.post('/agents/consumer/:agentId/complete', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { agentId } = req.params;
    const { categoryIds, budget, brandPreference, merchantPreference, timeline, location, publish = false, } = req.body;
...
//# sourceMappingURL=consumerDemand.js.map
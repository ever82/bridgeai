 ...
 * @access Private
 */
router.get('/:id/profile/l1', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
 ...
 * @access Private
 */
router.put('/:id/profile/l1', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { id } = req.params;
 ...
 * @access Private
 */
router.get('/:id/profile/completion', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { id } = req.params;
 ...
 * @access Private
 */
router.get('/:id/profile/l2', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { id } = req.params;
 ...
 * @access Private
 */
router.get('/:id/profile/l2/:sceneId', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
 ...
 * @access Private
 */
router.put('/:id/profile/l2/:sceneId', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { id, sceneId } = req.params;
 ...
 * @access Private
 */
router.get('/:id/profile/l3', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { id } = req.params;
 ...
 * @access Private
 */
router.put('/:id/profile/l3', authenticate, asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new AppError('Unauthorized', 'UNAUTHORIZED', 401);
    }
    const { id } = req.params;

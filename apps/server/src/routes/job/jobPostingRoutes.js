...
import { createJob, getJob, updateJob, updateStatus, refreshJob, deleteJob, listJobs, getMyJobs, getJobStatistics, getMyStatistics, getApplications, updateApplication, evaluateJobQuality, extractJob, } from '../../controllers/job/jobPostingController';
const router = Router();
// Public routes
router.get('/', listJobs);
...
//# sourceMappingURL=jobPostingRoutes.js.map
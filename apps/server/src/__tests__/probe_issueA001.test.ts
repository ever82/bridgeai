...
describe('ISSUE-A001 Probe Tests', () => {
  const mockUser = {
    id: 'user-123',
  ...
  describe('PT-001: Token Blacklist Bypass via JTI Collision', () => {
    test('should detect if tokens can be replayed after logout', async () => {
  ...
  describe('PT-002: Password Reset Token Reuse', () => {
    test('should prevent reset token reuse after password change', async () => {
  ...
  describe('PT-003: Rate Limiter Bypass via IP Spoofing', () => {
    test('should verify X-Forwarded-For header is not trusted', async () => {
  ...
  describe('PT-004: OAuth State Parameter Validation', () => {
    test('should ensure OAuth state parameter prevents CSRF', async () => {
  ...
  describe('PT-005: Email/Phone Registration Edge Cases', () => {
    ...
    test('should prevent registration with no contact method', async () => {
  ...
  describe('PT-006: Token Expiration Race Condition', () => {
    test('should handle token expiration during request', async () => {
  ...
  describe('PT-007: Refresh Token Rotation Attack', () => {
    test('should detect refresh token reuse detection', async () => {
  ...
  describe('PT-008: Verification Code Brute Force', () => {
    test('should limit verification code attempts', async () => {
      // 探针: 检查验证码是否有尝试次数限制
  ...
  describe('PT-009: Password Hash Timing Attack', () => {
    test('should verify bcrypt timing is constant', async () => {
      // 探针: 检查密码比较是否防时序攻击
  ...
  describe('PT-010: Mobile Token Storage Security', () => {
    test.skip('should ensure tokens are not stored in AsyncStorage - requires mobile repo access', () => {
  ...
  describe('PT-011: SQL Injection in User Search', () => {
    test('should verify user search is parameterized', async () => {
      // 探针: 检查用户搜索是否使用参数化查询
  ...
  describe('PT-012: JWT Secret Strength Validation', () => {
    test('should verify JWT secret meets minimum entropy', async () => {
  ...
  describe('PT-013: Logout All Implementation', () => {
    test('should verify logout-all actually revokes all tokens', async () => {
  ...
  describe('PT-014: Account Lockout Bypass via Registration', () => {
    test('should prevent lockout bypass by re-registering', async () => {
  ...
  describe('PT-015: CORS Configuration for OAuth', () => {
    test('should verify OAuth callback origins are restricted', async () => {

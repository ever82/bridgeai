...
const creditPaymentService_1 = require("../services/payment/creditPaymentService");
const pointsService_1 = require("../services/pointsService");
const payment_types_1 = require("../../../shared/types/payment.types");
describe('CreditPaymentService', () => {
    let service;
    beforeEach(() => {
        jest.clearAllMocks();
        service = new creditPaymentService_1.CreditPaymentService();
    });
    describe('processPayment', () => {
        ...
        it('should reject payment with insufficient balance', async () => {
            pointsService_1.pointsService.getOrCreateAccount.mockResolvedValue({
                id: 'acc-1',
                balance: 10,
                totalEarned: 10,
                totalSpent: 0,
        ...
        it('should process single photo payment successfully', async () => {
            ...
            expect(pointsService_1.pointsService.spendByRule).toHaveBeenCalledWith(expect.objectContaining({
                userId,
                ruleCode: 'VIEW_PHOTO',
                baseAmount: 20,
            }));
    ...
    describe('download tokens', () => {
        ...
        it('should reject download token generation for locked photo', async () => {
            ...
            await expect(service.generateDownloadToken('photo-2', 'user-1')).rejects.toThrow('Photo is not unlocked');
        });
    ...
    describe('getPaymentStatus', () => {
        it('should return FAILED for unknown transaction', async () => {
            ...
            expect(status).toBe(payment_types_1.PaymentStatus.FAILED);
        });
        it('should return COMPLETED for successful payment', async () => {
            ...
            expect(status).toBe(payment_types_1.PaymentStatus.COMPLETED);
        });
    });
...
//# sourceMappingURL=creditPaymentService.test.js.map
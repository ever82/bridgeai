...
describe('QueryBuilder', () => {
  ...
  describe('validateFilterDSL', () => {
    ...
    it('should reject missing where clause', () => {
      ...
      const result = validateFilterDSL(dsl as any);
  ...
  describe('buildJsonFieldFilter', () => {
    it('should build JSON path filter with equals', () => {
      const result = buildJsonFieldFilter('profile', ['l2Data', 'budget'], 'eq', 1000);
    ...
    it('should build JSON path filter with contains', () => {
      const result = buildJsonFieldFilter('metadata', ['tags'], 'contains', 'important');
    ...
    it('should handle single-level JSON paths', () => {
      const result = buildJsonFieldFilter('config', ['enabled'], 'eq', true);

...
describe('Vision API Routes', () => {
  ...
  describe('POST /api/v1/ai/vision/analyze', () => {
    ...
    it('should return 400 when no image provided', async () => {
      const response = await request(app).post('/api/v1/ai/vision/analyze').send({});
  ...
  describe('POST /api/v1/ai/vision/search', () => {
    ...
    it('should return 400 when query is missing', async () => {
      const response = await request(app).post('/api/v1/ai/vision/search').send({});
  ...
  describe('GET /api/v1/ai/vision/health', () => {
    it('should return health status', async () => {
      const response = await request(app).get('/api/v1/ai/vision/health');

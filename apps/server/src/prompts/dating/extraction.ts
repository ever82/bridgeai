 ...
 */
export function buildExtractionPrompt(text: string, currentProfile?: Record<string, any>): string {
 ...
 */
export function buildIntroductionExtractionPrompt(introduction: string): string {
 ...
 */
export function buildImplicitPreferencePrompt(text: string): string {
 ...
 */
export function buildSmartCompletionPrompt(
  partialProfile: Record<string, any>,
  description?: string
): string {

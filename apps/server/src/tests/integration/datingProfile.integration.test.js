...
async function createTestAgent(userId) {
    const agent = await client_1.prisma.agent.create({
        data: {
            id: (0, crypto_1.randomUUID)(),
            userId,
            type: 'AGENTDATE',
 ...
 */
async function _cleanupDatingProfile(agentId) {
 ...
 */
async function cleanupAgents(userId) {
...
function buildFullProfilePayload() {
    return {
        ...
        description: 'I am a kind and responsible person looking for a serious relationship. I enjoy running, listening to jazz, and traveling around the world.',
        privacySettings: {
...
describe('Dating Profile Integration', () => {
    ...
    describe('POST /api/v1/dating/agents/:agentId/profile - Create Profile', () => {
        ...
        it('should return 404 for non-existent agent', async () => {
            ...
            const headers = getUserAuthHeader(user);
            const response = await (0, supertest_1.default)(app)
                .post(`/api/v1/dating/agents/${(0, crypto_1.randomUUID)()}/profile`)
                .set(headers)
                .send(buildFullProfilePayload());
    ...
    describe('GET /api/v1/dating/agents/:agentId/profile - Read Profile', () => {
        ...
        it('should return 401 without authentication', async () => {
            const response = await (0, supertest_1.default)(app).get(`/api/v1/dating/agents/some-agent-id/profile`);
            expect(response.status).toBe(401);
        });
    });
    describe('PUT /api/v1/dating/agents/:agentId/profile - Update Profile', () => {
        it('should update an existing profile with partial data', async () => {
            ...
            const response = await (0, supertest_1.default)(app)
                ...
                .set(headers)
                .send({
                description: 'Updated description with more details about my life and interests. I love hiking and cooking.',
                lifestyle: {
    ...
    describe('DELETE /api/v1/dating/agents/:agentId/profile - Delete Profile', () => {
        ...
        it('should return 401 without authentication', async () => {
            const response = await (0, supertest_1.default)(app).delete(`/api/v1/dating/agents/some-agent-id/profile`);
            expect(response.status).toBe(401);
        });
    });
    ...
    describe('Full CRUD Flow', () => {
        it('should handle complete profile lifecycle', async () => {
            ...
            let res = await (0, supertest_1.default)(app).get(`/api/v1/dating/agents/${agentId}/profile`).set(headers);
            ...
            // Step 3: Read profile
            res = await (0, supertest_1.default)(app).get(`/api/v1/dating/agents/${agentId}/profile`).set(headers);
            ...
            res = await (0, supertest_1.default)(app).get(`/api/v1/dating/agents/${agentId}/profile/quality`).set(headers);
            expect(res.status).toBe(200);
            ...
            res = await (0, supertest_1.default)(app)
                ...
                .set(headers)
                .send({
                description: 'Updated: I am a software engineer who loves outdoor activities and cooking. Looking for someone who shares similar interests and values honesty and kindness above all.',
                personality: {
                    mbti: 'ENFJ',
            ...
            res = await (0, supertest_1.default)(app).delete(`/api/v1/dating/agents/${agentId}/profile`).set(headers);
            expect(res.status).toBe(200);
...
//# sourceMappingURL=datingProfile.integration.test.js.map
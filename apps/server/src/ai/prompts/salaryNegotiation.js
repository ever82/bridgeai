 ...
 */
export function getCounterOfferPrompt(context) {
 ...
 */
export function getMessagePrompt(context) {
 ...
 */
export function getAgreementCheckPrompt(context) {
    const { room, messages } = context;
 ...
 */
export function getSummaryPrompt(context) {
    const { room, messages } = context;
 ...
 */
export function getSalaryNegotiationPrompt(type, context) {
    switch (type) {
        case 'strategy':

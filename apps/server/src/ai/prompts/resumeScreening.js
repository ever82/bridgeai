...
// ---------------------------------------------------------------------------
export function getScreeningPrompt(context) {
...
// ---------------------------------------------------------------------------
export function getBatchScreeningPrompt(resumes, jobCriteria) {
...
// ---------------------------------------------------------------------------
export function getRecommendationExplanationPrompt(candidateProfile, jobPosting, matchScore) {

...
describe('Message Schemas', () => {
    describe('createConversationSchema', () => {
        it('should validate valid conversation creation', () => {
            const result = messageSchemas_1.createConversationSchema.safeParse({
    ...
    describe('sendMessageRequestSchema', () => {
        ...
        it('should validate valid message', () => {
            const result = messageSchemas_1.sendMessageRequestSchema.safeParse(validMessage);
            expect(result.success).toBe(true);
        });
        it('should require content', () => {
            const result = messageSchemas_1.sendMessageRequestSchema.safeParse({
                content: '',
            });
            expect(result.success).toBe(false);
        });
    ...
    describe('updateMessageSchema', () => {
        it('should allow partial updates', () => {
            const result = messageSchemas_1.updateMessageSchema.safeParse({
    ...
    describe('conversationIdParamsSchema', () => {
        it('should validate UUID format', () => {
            const result = messageSchemas_1.conversationIdParamsSchema.safeParse({
    ...
    describe('messageIdParamsSchema', () => {
        it('should validate UUID format', () => {
            const result = messageSchemas_1.messageIdParamsSchema.safeParse({
    ...
    describe('listMessagesQuerySchema', () => {
        it('should validate with defaults', () => {
            const result = messageSchemas_1.listMessagesQuerySchema.safeParse({});
            expect(result.success).toBe(true);
            if (result.success) {
    ...
    describe('listConversationsQuerySchema', () => {
        it('should validate with defaults', () => {
            const result = messageSchemas_1.listConversationsQuerySchema.safeParse({});
            expect(result.success).toBe(true);
            if (result.success) {
                expect(result.data.page).toBe(1);
    ...
    describe('searchMessagesQuerySchema', () => {
        it('should require search query', () => {
            const result = messageSchemas_1.searchMessagesQuerySchema.safeParse({});
            expect(result.success).toBe(false);
        });
...
//# sourceMappingURL=messageSchemas.test.js.map
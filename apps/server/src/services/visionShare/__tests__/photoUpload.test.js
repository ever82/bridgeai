...
const photoUpload_1 = require("../photoUpload");
const imageSecurity_1 = require("../../security/imageSecurity");
...
describe('PhotoUploadService', () => {
    ...
    beforeEach(() => {
        ...
        photoUpload_1.PhotoUploadService.instance = undefined;
        mockSecurityService = imageSecurity_1.ImageSecurityService.getInstance();
        mockSecurityService.checkImage.mockResolvedValue({
            passed: true,
            violations: [],
            warnings: [],
            metadata: {
        ...
        mockSecurityService.compressImage.mockResolvedValue(Buffer.from('compressed'));
        mockSecurityService.createThumbnail.mockResolvedValue(Buffer.from('thumbnail'));
        service = photoUpload_1.PhotoUploadService.getInstance();
    });
    ...
    describe('uploadBatch', () => {
        ...
        it('should report progress', async () => {
            ...
            const options = { userId: 'user-1', onProgress };
    ...
    describe('chunked upload', () => {
        ...
        it('should throw error for invalid upload session', async () => {
            await expect(service.uploadChunk('invalid-id', 0, Buffer.from('chunk'))).rejects.toThrow('Upload session not found');
        });
...
//# sourceMappingURL=photoUpload.test.js.map
...
const imageSecurity_1 = require("../imageSecurity");
...
describe('ImageSecurityService', () => {
    let service;
    beforeEach(() => {
        service = imageSecurity_1.ImageSecurityService.getInstance();
    });
    describe('checkImage', () => {
        ...
        it('should fail unsupported formats', async () => {
            ...
            sharp_1.default.mockImplementationOnce(() => ({
...
//# sourceMappingURL=imageSecurity.test.js.map
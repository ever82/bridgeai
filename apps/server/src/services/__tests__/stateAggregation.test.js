 ...
 */
const stateAggregation_1 = require("../stateAggregation");
describe('StateAggregationService', () => {
    let service;
    beforeEach(() => {
        service = new stateAggregation_1.StateAggregationService();
    });
    afterEach(() => {
        service.destroy();
    });
    ...
    describe('flushBatch', () => {
        ...
        it('deduplicates updates for same type/target', (done) => {
            service.on('batch:ready', (batch) => {
                ...
                const user1Updates = batch.updates.filter((u) => u.targetId === 'user1');
...
//# sourceMappingURL=stateAggregation.test.js.map
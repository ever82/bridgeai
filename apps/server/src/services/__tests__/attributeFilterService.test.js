...
const attributeFilterService_1 = require("../attributeFilterService");
// ============================================
// Test data
// ============================================
...
describe('validateAttributeFilter', () => {
    it('returns valid for correct agentdate filters', () => {
        const result = (0, attributeFilterService_1.validateAttributeFilter)('agentdate', {
    ...
    it('returns valid for correct agentjob filters', () => {
        const result = (0, attributeFilterService_1.validateAttributeFilter)('agentjob', {
    ...
    it('returns valid for correct visionshare filters', () => {
        const result = (0, attributeFilterService_1.validateAttributeFilter)('visionshare', {
    ...
    it('returns valid for correct agentad filters', () => {
        const result = (0, attributeFilterService_1.validateAttributeFilter)('agentad', {
...
describe('filterAgentsByAttributes', () => {
    ...
    it('throws on invalid filters', async () => {
        await expect((0, attributeFilterService_1.filterAgentsByAttributes)({
            sceneId: 'agentdate',
            filters: { nonexistent: { include: ['x'] } },
    ...
    it('accepts valid filter options', async () => {
        ...
        const validation = (0, attributeFilterService_1.validateAttributeFilter)(options.sceneId, options.filters);
...
describe('visionShareFilterBuilder', () => {
    it('builds a complete VisionShare filter', () => {
        const filter = (0, attributeFilterService_1.visionShareFilterBuilder)()
    ...
    it('builds a minimal VisionShare filter', () => {
        const filter = (0, attributeFilterService_1.visionShareFilterBuilder)().contentType(['photography']).build();
        expect(filter).toEqual({
            contentType: { include: ['photography'] },
        });
    });
...
describe('agentDateFilterBuilder', () => {
    it('builds a complete AgentDate filter', () => {
        const filter = (0, attributeFilterService_1.agentDateFilterBuilder)()
            .ageRange(25, 35)
            .gender(['FEMALE'], ['MALE'])
    ...
    it('builds a minimal AgentDate filter', () => {
        const filter = (0, attributeFilterService_1.agentDateFilterBuilder)().gender(['FEMALE']).build();
        expect(filter).toEqual({
            gender: { include: ['FEMALE'] },
        });
    });
...
describe('agentJobFilterBuilder', () => {
    it('builds a complete AgentJob filter', () => {
        const filter = (0, attributeFilterService_1.agentJobFilterBuilder)()
    ...
    it('builds a minimal AgentJob filter', () => {
        const filter = (0, attributeFilterService_1.agentJobFilterBuilder)().jobType(['full_time']).build();
        expect(filter).toEqual({
            jobType: { include: ['full_time'] },
        });
    });
...
describe('agentAdFilterBuilder', () => {
    it('builds a complete AgentAd filter', () => {
        const filter = (0, attributeFilterService_1.agentAdFilterBuilder)()
    ...
    it('builds a minimal AgentAd filter', () => {
        const filter = (0, attributeFilterService_1.agentAdFilterBuilder)().adType(['product']).build();
        expect(filter).toEqual({
            adType: { include: ['product'] },
        });
    });
...
describe('calculateTagOverlap', () => {
    it('calculates full overlap', () => {
        expect((0, attributeFilterService_1.calculateTagOverlap)(['a', 'b', 'c'], ['a', 'b', 'c'])).toBe(1);
    });
    it('calculates partial overlap', () => {
        expect((0, attributeFilterService_1.calculateTagOverlap)(['a', 'b', 'c'], ['a', 'd'])).toBe(1 / 3);
    });
    it('returns 0 for no overlap', () => {
        expect((0, attributeFilterService_1.calculateTagOverlap)(['a', 'b'], ['c', 'd'])).toBe(0);
    });
    it('returns 0 when first array is empty', () => {
        expect((0, attributeFilterService_1.calculateTagOverlap)([], ['a', 'b'])).toBe(0);
    });
    it('returns 0 when second array is empty', () => {
        expect((0, attributeFilterService_1.calculateTagOverlap)(['a', 'b'], [])).toBe(0);
    });
    it('calculates overlap with duplicates in second array', () => {
        expect((0, attributeFilterService_1.calculateTagOverlap)(['a', 'b'], ['a', 'a', 'b'])).toBe(1);
    });
});
// ============================================
...
describe('matchesAttributeFilter', () => {
    it('matches enum include filter', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { gender: { include: ['FEMALE'] } }, 'agentdate');
        expect(result).toBe(true);
    });
    it('fails enum include filter when value not in list', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { gender: { include: ['MALE'] } }, 'agentdate');
        expect(result).toBe(false);
    });
    it('fails enum exclude filter when value is excluded', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { gender: { exclude: ['FEMALE'] } }, 'agentdate');
        expect(result).toBe(false);
    });
    it('matches enum exclude filter when value is not excluded', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { gender: { exclude: ['MALE'] } }, 'agentdate');
        expect(result).toBe(true);
    });
    it('matches range filter within bounds', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { priceRange: { min: 50, max: 600 } }, 'visionshare');
        expect(result).toBe(true);
    });
    it('fails range filter when value below min', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { priceRange: { min: 600 } }, 'visionshare');
        expect(result).toBe(false);
    });
    it('fails range filter when value above max', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { priceRange: { max: 50 } }, 'visionshare');
        expect(result).toBe(false);
    });
    it('matches tags overlap filter with sufficient overlap', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { interests: { tags: ['music', 'hiking'], minOverlap: 0.5 } }, 'agentdate');
        expect(result).toBe(true);
    });
    it('fails tags overlap filter with insufficient overlap', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { interests: { tags: ['music', 'sports', 'gaming', 'reading'], minOverlap: 0.5 } }, 'agentdate');
        expect(result).toBe(false);
    });
    it('uses default minOverlap of 0.5 for tags', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { interests: { tags: ['music', 'hiking'] } }, 'agentdate');
        expect(result).toBe(true);
    });
    it('matches boolean filter', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { hasChildren: false }, 'agentdate');
        expect(result).toBe(true);
    });
    it('fails boolean filter when value differs', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { hasChildren: true }, 'agentdate');
        expect(result).toBe(false);
    });
    it('ignores undefined/null filter values', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, { gender: undefined, age: null }, 'agentdate');
        expect(result).toBe(true);
    });
    it('handles missing profile value gracefully for tags', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)({ l1Data: {} }, { interests: { tags: ['music'] } }, 'agentdate');
        expect(result).toBe(true); // missing array value is skipped
    });
    it('handles missing profile value gracefully for range', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)({ l1Data: {} }, { priceRange: { min: 100 } }, 'visionshare');
        expect(result).toBe(true); // missing numeric value is skipped
    });
    it('handles multiple filter conditions (all must match)', () => {
        const result = (0, attributeFilterService_1.matchesAttributeFilter)(mockAgentProfile, {
            gender: { include: ['FEMALE'] },
            education: { include: ['BACHELOR'] },
        }, 'agentdate');
        expect(result).toBe(true);
...
//# sourceMappingURL=attributeFilterService.test.js.map
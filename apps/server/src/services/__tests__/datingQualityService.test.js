...
const qualityService = __importStar(require("../dating/profileQualityService"));
describe('ProfileQualityService', () => {
    ...
    describe('calculateProfileQuality', () => {
        ...
        it('should provide suggestions for incomplete profile', () => {
            ...
            const result = qualityService.calculateProfileQuality(profile);
            expect(result.recommendations.length).toBeGreaterThan(0);
            const hasDescriptionSuggestion = result.recommendations.some(r => r.field === 'description');
...
//# sourceMappingURL=datingQualityService.test.js.map
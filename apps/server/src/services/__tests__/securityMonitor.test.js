...
describe('Security Monitor Service', () => {
    beforeEach(() => {
        ...
        (0, securityMonitor_1.resetAggregations)();
        (0, securityMonitor_1.updateConfig)({ realTimeMonitoring: true });
    });
    afterEach(() => {
    ...
    describe('initializeSecurityMonitoring', () => {
        it('should initialize without errors', () => {
            expect(() => (0, securityMonitor_1.initializeSecurityMonitoring)()).not.toThrow();
        });
        it('should log initialization message', () => {
            (0, securityMonitor_1.initializeSecurityMonitoring)();
            expect(console.log).toHaveBeenCalledWith('[Security Monitor] Initialized with config:', expect.any(Object));
        });
    });
    describe('trackSecurityEvent', () => {
        it('should track DDoS detected events', () => {
            ...
            (0, securityMonitor_1.trackSecurityEvent)(event);
            const stats = (0, securityMonitor_1.getRealTimeStats)();
        ...
        it('should aggregate multiple events of same type', () => {
            ...
            const stats = (0, securityMonitor_1.getRealTimeStats)();
            const sqlInjectionAgg = stats.eventAggregations.find(ea => ea.type === 'SQL_INJECTION_ATTEMPT');
    ...
    describe('getRealTimeStats', () => {
        ...
        it('should update after tracking events', () => {
            const initialStats = (0, securityMonitor_1.getRealTimeStats)();
            const event = {
                id: 'test-stats',
            ...
            (0, securityMonitor_1.trackSecurityEvent)(event);
            const updatedStats = (0, securityMonitor_1.getRealTimeStats)();
    ...
    describe('updateConfig', () => {
        it('should update configuration', () => {
            ...
            (0, securityMonitor_1.updateConfig)(newConfig);
            const config = (0, securityMonitor_1.getConfig)();
    ...
    describe('getConfig', () => {
        ...
        it('should return a copy of config', () => {
            const config1 = (0, securityMonitor_1.getConfig)();
            const config2 = (0, securityMonitor_1.getConfig)();
    ...
    describe('resetAggregations', () => {
        it('should clear all aggregations', () => {
            ...
            (0, securityMonitor_1.trackSecurityEvent)(event);
            const statsBefore = (0, securityMonitor_1.getRealTimeStats)();
            expect(statsBefore.recentEvents).toBeGreaterThan(0);
            (0, securityMonitor_1.resetAggregations)();
            const statsAfter = (0, securityMonitor_1.getRealTimeStats)();
    ...
    describe('exportSecurityData', () => {
        it('should export data in JSON format', () => {
            ...
            (0, securityMonitor_1.trackSecurityEvent)(event);
            const data = (0, securityMonitor_1.exportSecurityData)('json', new Date(Date.now() - 3600000));
            expect(() => JSON.parse(data)).not.toThrow();
            const parsed = JSON.parse(data);
            expect(Array.isArray(parsed)).toBe(true);
        });
        it('should export data in CSV format', () => {
            const data = (0, securityMonitor_1.exportSecurityData)('csv');
    ...
    describe('Threshold alerts', () => {
        beforeEach(() => {
            (0, securityMonitor_1.updateConfig)({
...
//# sourceMappingURL=securityMonitor.test.js.map
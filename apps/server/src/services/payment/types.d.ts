...
export interface ITransactionService {
    ...
    updateTransactionStatus(transactionId: string, status: PaymentStatus, metadata?: Record<string, unknown>): Promise<PaymentTransaction>;
    /** Get transaction by ID */
    getTransaction(transactionId: string): Promise<PaymentTransaction | null>;
    /** Get user transactions with pagination */
    getUserTransactions(userId: string, options: TransactionQueryOptions): Promise<TransactionQueryResult>;

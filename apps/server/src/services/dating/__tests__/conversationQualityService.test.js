...
const conversationQualityService_1 = require("../conversationQualityService");
describe('conversationQualityService', () => {
    describe('calculateFluency', () => {
        it('should score message patterns', async () => {
            ...
            const score = await (0, conversationQualityService_1.calculateFluency)(messages);
        ...
        it('should reward good turn-taking patterns', async () => {
            ...
            const score = await (0, conversationQualityService_1.calculateFluency)(alternatingMessages);
    ...
    describe('analyzeEngagement', () => {
        it('should measure participation balance', async () => {
            ...
            const score = await (0, conversationQualityService_1.analyzeEngagement)(balancedMessages, 'agent-a', 'agent-b');
            expect(score).toBeGreaterThan(0.5);
        });
        it('should penalize imbalanced participation', async () => {
            ...
            const score = await (0, conversationQualityService_1.analyzeEngagement)(imbalancedMessages, 'agent-a', 'agent-b');
        ...
        it('should reward questions in messages', async () => {
            ...
            const score = await (0, conversationQualityService_1.analyzeEngagement)(questioningMessages, 'agent-a', 'agent-b');
            expect(score).toBeGreaterThan(0.5);
        });
        it('should return 0.5 for insufficient messages', async () => {
            const messages = [{ role: 'user', content: 'Single message' }];
            const score = await (0, conversationQualityService_1.analyzeEngagement)(messages, 'agent-a', 'agent-b');
            expect(score).toBe(0.5);
        });
    });
    describe('detectIssues', () => {
        it('should identify low engagement issues', async () => {
            ...
            const issues = await (0, conversationQualityService_1.detectIssues)(shortMessages, 1);
        ...
        it('should identify repetitive content', async () => {
            ...
            const issues = await (0, conversationQualityService_1.detectIssues)(repetitiveMessages, 1);
        ...
        it('should identify stalled conversation', async () => {
            ...
            const issues = await (0, conversationQualityService_1.detectIssues)(stalledMessages, 1);
        ...
        it('should identify inappropriate content', async () => {
            ...
            const issues = await (0, conversationQualityService_1.detectIssues)(inappropriateMessages, 1);
        ...
        it('should return empty array for insufficient messages', async () => {
            const messages = [{ role: 'user', content: 'Single message' }];
            const issues = await (0, conversationQualityService_1.detectIssues)(messages, 1);
        ...
        it('should not identify issues in healthy conversation', async () => {
            ...
            const issues = await (0, conversationQualityService_1.detectIssues)(healthyMessages, 1);
    ...
    describe('assessConversation', () => {
        it('should return complete quality assessment', async () => {
            ...
            const assessment = await (0, conversationQualityService_1.assessConversation)('room-123', messages, 1);
        ...
        it('should cache assessment results', async () => {
            ...
            await (0, conversationQualityService_1.assessConversation)('room-456', messages, 1);
            await (0, conversationQualityService_1.assessConversation)('room-456', messages, 2);
            const trend = await (0, conversationQualityService_1.getQualityTrend)('room-456');
            expect(trend.assessments.length).toBe(2);
        });
    });
    describe('getQualityTrend', () => {
        it('should return empty trend for non-existent room', async () => {
            const trend = await (0, conversationQualityService_1.getQualityTrend)('non-existent-room');
        ...
        it('should calculate average score correctly', async () => {
            ...
            await (0, conversationQualityService_1.assessConversation)('room-789', messages, 1);
            const trend = await (0, conversationQualityService_1.getQualityTrend)('room-789');
            expect(trend.assessments.length).toBe(1);
            expect(trend.averageScore).toBeGreaterThan(0);
        });
    });
});
//# sourceMappingURL=conversationQualityService.test.js.map
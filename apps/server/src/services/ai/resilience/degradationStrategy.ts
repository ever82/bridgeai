 ...
 */
class BackupModelHandler implements DegradationLevelHandler {
 ...
 */
class LowCostModelHandler implements DegradationLevelHandler {
  ...
  private getModelCost(modelId: string, models: Map<string, ModelInfo>): number {
 ...
 */
class TemplateResponseHandler implements DegradationLevelHandler {
 ...
 */
class AsyncQueueHandler implements DegradationLevelHandler {
 ...
 */
class UnavailableHandler implements DegradationLevelHandler {
...
export class DegradationStrategy extends EventEmitter {
  private handlers: Map<DegradationLevel, DegradationLevelHandler> = new Map();
  ...
  async execute(
    request: ChatCompletionRequest,
    context: DegradationContext,
    startLevel: DegradationLevel = DegradationLevel.L1_BACKUP_MODEL
  ): Promise<DegradationResult> {

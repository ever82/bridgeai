...
export class AgentJobExtractor extends BaseSceneExtractor {
     ...
     */
    extractExperience(text, entities) {
        const experience = {};
     ...
     */
    extractSalaryExpectation(text, entities) {
        const salary = {
...
//# sourceMappingURL=agentJobExtractor.js.map
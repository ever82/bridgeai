 ...
 * 场景特定实体类型
 */
export type SceneEntityType = 'photographyType' | 'photographyTime' | 'age' | 'height' | 'education' | 'occupation' | 'interest' | 'skill' | 'experience' | 'salary' | 'jobType' | 'benefit' | 'product' | 'brand' | 'platform' | 'urgency' | 'time' | 'location' | 'budget' | 'person' | 'requirement' | 'preference';
/**

 ...
 */
import { L2FieldType, getL2Schema } from '@bridgeai/shared';
 ...
 */
export async function extractL2FromL3(request) {
 ...
 */
function buildExtractionPrompt(text, schema) {
 ...
 */
function parseExtractionResult(text, schema) {
    try {
 ...
 */
export async function reExtractWithCorrections(request, userCorrections) {

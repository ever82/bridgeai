...
const supplyQualityAssessor_1 = require("../supplyQualityAssessor");
...
describe('SupplyQualityAssessor', () => {
    ...
    const createMinimalSupply = (overrides) => ({
        id: 'supply-min',
        title: 'Svc',
        description: 'Short',
        serviceType: 'general',
    ...
    beforeEach(() => {
        assessor = new supplyQualityAssessor_1.SupplyQualityAssessor();
    });
    describe('assess', () => {
    ...
    describe('quality grade', () => {
        ...
        it('should assign grades B/C/D for intermediate scores', () => {
            ...
            const supply = createFullSupply({ description: 'Medium desc', capabilities: [{
                        name: 'Test', description: 'Test', level: 'intermediate', category: 'test', keywords: [],
                    }] });
            const result = assessor.assess(supply);
    ...
    describe('optimization suggestions', () => {
        ...
        it('should suggest fixing pricing inconsistency', () => {
            ...
            const result = assessor.assess(supply);
            const fixSuggestion = result.optimizationSuggestions.find(s => s.type === 'fix_inconsistency' && s.field === 'pricing');
...
//# sourceMappingURL=supplyQualityAssessor.test.js.map
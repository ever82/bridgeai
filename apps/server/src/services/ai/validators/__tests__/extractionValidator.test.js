...
const extractionValidator_1 = require("../extractionValidator");
...
describe('ExtractionValidator', () => {
    ...
    describe('summary', () => {
        ...
        it('should calculate total issues', () => {
            const data = {};
            const report = validator.validate(data, mockSchema);
            expect(report.summary.totalIssues).toBe(report.summary.errorCount + report.summary.warningCount + report.summary.infoCount);
        });
    });
});
//# sourceMappingURL=extractionValidator.test.js.map
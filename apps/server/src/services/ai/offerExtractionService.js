 ...
 */
import { OfferType, UserGroup, } from '../../types/offer.types';
/**
 ...
 */
export async function extractOfferFromText(naturalLanguageText) {
 ...
 */
function parseNaturalLanguageOffer(text) {
 ...
 */
export async function processNaturalLanguageOffer(naturalLanguageText, merchantId) {
    try {
...
//# sourceMappingURL=offerExtractionService.js.map
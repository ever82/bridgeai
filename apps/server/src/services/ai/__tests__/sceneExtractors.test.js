...
describe('Scene Extractors', () => {
    describe('VisionShareExtractor', () => {
        let extractor;
        beforeEach(() => {
            extractor = new extractors_1.VisionShareExtractor();
        });
    ...
    describe('AgentDateExtractor', () => {
        let extractor;
        beforeEach(() => {
            extractor = new extractors_1.AgentDateExtractor();
        });
    ...
    describe('AgentJobExtractor', () => {
        let extractor;
        beforeEach(() => {
            extractor = new extractors_1.AgentJobExtractor();
        });
    ...
    describe('AgentAdExtractor', () => {
        let extractor;
        beforeEach(() => {
            extractor = new extractors_1.AgentAdExtractor();
        });
...
//# sourceMappingURL=sceneExtractors.test.js.map
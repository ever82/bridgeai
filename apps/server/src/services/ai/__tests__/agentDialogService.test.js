...
const agentDialogService_1 = require("../agentDialogService");
...
describe('AgentDialogService', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        service = new agentDialogService_1.AgentDialogService();
    });
    ...
    describe('updateSessionContext', () => {
        ...
        it('should throw for non-existent session', async () => {
            await expect(service.updateSessionContext('non-existent', { goals: ['test'] })).rejects.toThrow('Session non-existent not found');
        });
    });
    ...
    describe('getSessionMessages', () => {
        ...
        it('should throw for non-existent session', async () => {
            await expect(service.getSessionMessages('non-existent')).rejects.toThrow('Session non-existent not found');
        });
    });
    describe('getVersion', () => {
...
//# sourceMappingURL=agentDialogService.test.js.map
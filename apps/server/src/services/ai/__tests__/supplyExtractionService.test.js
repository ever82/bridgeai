...
const supplyExtractionService_1 = require("../supplyExtractionService");
// Mock LLMService
...
describe('SupplyExtractionService', () => {
    ...
    beforeEach(() => {
        ...
        // 创建服务实例
        service = new supplyExtractionService_1.SupplyExtractionService(mockLLMService);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
...
//# sourceMappingURL=supplyExtractionService.test.js.map
...
const demandExtractionService_1 = require("../demandExtractionService");
// Mock dependencies
...
const mockedLlmService = llmService_1.llmService;
const mockedMetricsService = metricsService_1.metricsService;
describe('DemandExtractionService', () => {
    let service;
    beforeEach(() => {
        service = new demandExtractionService_1.DemandExtractionService();
        jest.clearAllMocks();
    ...
    describe('options handling', () => {
        it('should respect extractEntities option', async () => {
            ...
            const result = await service.extract({ text: '测试', scene: 'visionShare' }, { extractEntities: false });
        ...
        it('should respect classifyIntent option', async () => {
            ...
            const result = await service.extract({ text: '测试', scene: 'visionShare' }, { classifyIntent: false });
            expect(result.intent.intent).toBe('unknown');
            expect(result.intent.confidence).toBe(0);
        });
    });
});
//# sourceMappingURL=demandExtractionService.test.js.map
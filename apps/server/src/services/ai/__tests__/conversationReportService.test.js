...
const conversationReportService_1 = require("../conversationReportService");
describe('ConversationReportService', () => {
    ...
    beforeEach(() => {
        service = new conversationReportService_1.ConversationReportService();
    });
    ...
    describe('generateReport', () => {
        it('should create report from session data', async () => {
            const report = await service.generateReport('room-123', mockSessionData, mockQualityAssessments);
        ...
        it('should use previous match score when not provided', async () => {
            ...
            const report = await service.generateReport('room-no-score', sessionWithoutScore, mockQualityAssessments);
    ...
    describe('getReport', () => {
        it('should return report by id', async () => {
            const generated = await service.generateReport('room-123', mockSessionData, mockQualityAssessments);
    ...
    describe('getReportsByUser', () => {
        ...
        it('should return reports sorted by creation time descending', async () => {
            ...
            for (let i = 1; i < reports.length; i++) {
                expect(reports[i - 1].createdAt.getTime()).toBeGreaterThanOrEqual(reports[i].createdAt.getTime());
            }
        });
    });
});
//# sourceMappingURL=conversationReportService.test.js.map
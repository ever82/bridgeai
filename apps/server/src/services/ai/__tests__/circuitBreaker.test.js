...
describe('CircuitBreaker', () => {
    let circuitBreaker;
    beforeEach(() => {
        circuitBreaker = new circuitBreaker_1.CircuitBreaker('openai', {
            failureThreshold: 3,
    ...
    describe('Execute Method', () => {
        ...
        it('should use fallback when circuit is open', async () => {
            ...
            const result = await circuitBreaker.execute(async () => 'success', fallback);
...
describe('CircuitBreakerManager', () => {
    ...
    describe('Circuit Breaker Management', () => {
        it('should create and get circuit breaker', () => {
            ...
            expect(cb).toBeInstanceOf(circuitBreaker_1.CircuitBreaker);

...
export class SearchRecommendationService {
    ...
    trendingSearches = new Map();
    userProfiles = new Map();
    similarQueries = new Map();
    constructor() {
     ...
     */
    async getHistoryBasedRecommendations(userId) {
     ...
     */
    async getSimilarRecommendations(userId) {
        const history = this.searchHistory.get(userId) || [];
        const recommendations = [];
     ...
     */
    async getDiscoveryRecommendations(userId) {
...
export function getSearchRecommendationService() {
    if (!serviceInstance) {
        serviceInstance = new SearchRecommendationService();
    }
    return serviceInstance;
}
//# sourceMappingURL=searchRecommendation.js.map
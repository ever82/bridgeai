...
let _masterClient: Redis | null = null;
let _slaveClient: Redis | null = null;
let _sentinelClient: Redis | null = null;
let _connectionState: 'disconnected' | 'connecting' | 'connected' | 'error' = 'disconnected';
 ...
 */
function createRedisClient(url: string, options?: Partial<Redis.RedisOptions>): Redis {
 ...
 */
function createSentinelClient(): Redis | null {
 ...
 */
function getMasterClient(): Redis {
  if (!_masterClient) {
 ...
 */
export function getSlaveClient(): Redis | null {
  return _slaveClient;
}
 ...
 */
export const redisWrite = new Proxy({} as Redis, {
  get(_target, prop) {
    if (typeof prop !== 'string') {
      return undefined;
    }
 ...
 */
export function getConnectionState(): 'disconnected' | 'connecting' | 'connected' | 'error' {

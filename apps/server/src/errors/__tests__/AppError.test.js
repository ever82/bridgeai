...
describe('AppError', () => {
    describe('base AppError', () => {
        it('should create error with default values', () => {
            const error = new AppError_1.AppError('Something went wrong');
        ...
        it('should create error with custom values', () => {
            ...
            const error = new AppError_1.AppError('Invalid email', 'VALIDATION_ERROR', 400, details, true);
        ...
        it('should be instance of Error', () => {
            const error = new AppError_1.AppError('Test');
    ...
    describe('NotFoundError', () => {
        ...
        it('should include details', () => {
            ...
            const error = new AppError_1.NotFoundError('User', details);
            expect(error.details).toEqual(details);
        });
    });
    describe('ValidationError', () => {
        ...
        it('should include validation details', () => {
            ...
            const error = new AppError_1.ValidationError('Password too short', details);
            expect(error.details).toEqual(details);
        });
    });
    describe('UnauthorizedError', () => {
        it('should create unauthorized error', () => {
            const error = new AppError_1.UnauthorizedError('Invalid credentials');
            expect(error.message).toBe('Invalid credentials');
            expect(error.code).toBe('UNAUTHORIZED');
            expect(error.statusCode).toBe(401);
        });
        it('should use default message', () => {
            const error = new AppError_1.UnauthorizedError();
            expect(error.message).toBe('Unauthorized');
        });
    });
    describe('ForbiddenError', () => {
        it('should create forbidden error', () => {
            const error = new AppError_1.ForbiddenError('Access denied');
            expect(error.message).toBe('Access denied');
            expect(error.code).toBe('FORBIDDEN');
            expect(error.statusCode).toBe(403);
        });
        it('should use default message', () => {
            const error = new AppError_1.ForbiddenError();
    ...
    describe('RateLimitError', () => {
        it('should create rate limit error', () => {
            const error = new AppError_1.RateLimitError('Too many requests');
        ...
        it('should include retry information', () => {
            ...
            const error = new AppError_1.RateLimitError('Rate limit exceeded', details);
            expect(error.details).toEqual(details);
        });
    });
});

 ...
 */
export const imageUploadCheck = async (req, res, next) => {
    try {
        ...
        req.imageSecurityResults = results.map((r) => ({
            filename: r.filename,
 ...
 */
export const uploadMixedImages = (fields) => [
...
//# sourceMappingURL=imageUploadCheck.js.map
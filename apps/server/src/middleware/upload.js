 ...
 */
function createFileFilter(allowedCategories, allowedMimeTypes) {
    return (req, file, cb) => {
...
export function uploadMultiple(options = {}) {
    const { categories, mimeTypes, maxSize, maxCount = 5, storage = 'memory', fieldName = 'files', } = options;
    const limits = {
        fileSize: maxSize || MAX_FILE_SIZES.default,
        files: maxCount,
    };
 ...
 */
export function uploadFields(fields, options = {}) {
 ...
 * Upload single image
 */
export function uploadImage(fieldName = 'image', maxSize) {
    return uploadSingle({
        categories: ['image'],
        fieldName,
 ...
 */
export function uploadImages(fieldName = 'images', maxCount = 10, maxSize) {
 ...
 */
export function uploadDocument(fieldName = 'document', maxSize) {
    return uploadSingle({
        categories: ['document'],
        fieldName,
 ...
 * Upload video
 */
export function uploadVideo(fieldName = 'video', maxSize) {
    return uploadSingle({
        categories: ['video'],
        fieldName,
 ...
 * Upload audio
 */
export function uploadAudio(fieldName = 'audio', maxSize) {
    return uploadSingle({
        categories: ['audio'],
        fieldName,

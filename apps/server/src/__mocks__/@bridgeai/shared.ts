...
export interface PrivacySettings {
  ...
  disclosureStages?: Array<{ stage: string; fields: string[] }>;
...
export function calculateDatingSimilarity(
  _profileA: DatingProfile,
  _profileB: DatingProfile,
  _weights?: Partial<SimilarityWeights>
) {
  return {
...
// Dating labels
export const DATING_AGE_RANGE_LABELS: Record<string, string> = {};
export const HEIGHT_RANGE_LABELS: Record<string, string> = {};
export const DATING_EDUCATION_LABELS: Record<string, string> = {};
export const INCOME_LABELS: Record<string, string> = {};
export const DATING_PURPOSE_LABELS: Record<string, string> = {};
...
// Dating Profile request/response types
...
export interface DatingProfileResponse {
  ...
  quality?: any;
  completion: { percentage: number; filledSections: number; totalSections: number };
}
...
export interface ProfileQualityResult {
  ...
  recommendations: Array<{ field: string; priority: string; suggestion: string }>;
}

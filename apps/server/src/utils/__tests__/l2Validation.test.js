...
const l2Validation_1 = require("../l2Validation");
const mockSchema = {
    id: 'test-schema',
    version: '1.0.0',
    scene: 'TEST',
    ...
    fields: [
        {
            id: 'name',
            type: shared_1.L2FieldType.TEXT,
            label: '名称',
            required: true,
            minLength: 2,
            maxLength: 50,
        ...
        {
            id: 'description',
            type: shared_1.L2FieldType.LONG_TEXT,
            label: '描述',
            required: false,
            maxLength: 500,
        },
        ...
        {
            id: 'tags',
            type: shared_1.L2FieldType.MULTI_SELECT,
            label: '标签',
            required: false,
            options: [
        ...
        {
            id: 'count',
            type: shared_1.L2FieldType.NUMBER,
            label: '数量',
            required: true,
            min: 0,
            max: 100,
        ...
        {
            id: 'priceRange',
            type: shared_1.L2FieldType.RANGE,
            label: '价格范围',
            required: false,
            min: 0,
            max: 10000,
        ...
        {
            id: 'isActive',
            type: shared_1.L2FieldType.BOOLEAN,
            label: '是否激活',
            required: false,
        },
    ],
...
describe('validateL2Data', () => {
    it('should pass with valid data', () => {
        ...
        const result = (0, l2Validation_1.validateL2Data)(data, mockSchema);
...
describe('getFieldValueLabel', () => {
    it('should return label for enum value', () => {
        ...
        const label = (0, l2Validation_1.getFieldValueLabel)(field, 'a');
        expect(label).toBe('选项A');
    });
    it('should return labels for multi-select values', () => {
        const field = mockSchema.fields[3]; // tags field
        const label = (0, l2Validation_1.getFieldValueLabel)(field, ['tag1', 'tag2']);
        expect(label).toBe('标签1, 标签2');
    });
    it('should return 是/否 for boolean values', () => {
        const field = mockSchema.fields[6]; // isActive field
        expect((0, l2Validation_1.getFieldValueLabel)(field, true)).toBe('是');
        expect((0, l2Validation_1.getFieldValueLabel)(field, false)).toBe('否');
    });
    it('should return range string for range values', () => {
        const field = mockSchema.fields[5]; // priceRange field
        const label = (0, l2Validation_1.getFieldValueLabel)(field, { min: 10, max: 100 });
        expect(label).toBe('10 - 100');
    });
    it('should return empty string for null/undefined', () => {
        const field = mockSchema.fields[0];
        expect((0, l2Validation_1.getFieldValueLabel)(field, null)).toBe('');
        expect((0, l2Validation_1.getFieldValueLabel)(field, undefined)).toBe('');
    });
});
describe('calculateL2Completion', () => {
    it('should calculate 100% when all required fields filled', () => {
        ...
        const result = (0, l2Validation_1.calculateL2Completion)(data, mockSchema);
...
//# sourceMappingURL=l2Validation.test.js.map
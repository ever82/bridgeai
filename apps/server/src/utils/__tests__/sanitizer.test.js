...
describe('Sanitizer', () => {
    describe('sanitizeString', () => {
        it('should redact password in JSON', () => {
            ...
            const result = (0, sanitizer_1.sanitizeString)(input);
        ...
        it('should handle empty string', () => {
            expect((0, sanitizer_1.sanitizeString)('')).toBe('');
        });
        it('should handle non-string input', () => {
            expect((0, sanitizer_1.sanitizeString)(null)).toBeNull();
            expect((0, sanitizer_1.sanitizeString)(undefined)).toBeUndefined();
        });
    });
    describe('sanitizeObject', () => {
        ...
        it('should handle custom sensitive fields', () => {
            ...
            const result = (0, sanitizer_1.sanitizeObject)(input, ['customSecret']);
    ...
    describe('sanitizeBody', () => {
        it('should sanitize string body', () => {
            ...
            const result = (0, sanitizer_1.sanitizeBody)(input);
            expect(result).toContain('[REDACTED]');
        });
        ...
        it('should return non-object body unchanged', () => {
            expect((0, sanitizer_1.sanitizeBody)(123)).toBe(123);
            expect((0, sanitizer_1.sanitizeBody)(true)).toBe(true);
        });
    });
    ...
    describe('sanitizeHeaders', () => {
        it('should redact authorization header', () => {
            ...
            const result = (0, sanitizer_1.sanitizeHeaders)(headers);
    ...
    describe('createSanitizer', () => {
        it('should return sanitizer functions', () => {
            const sanitizer = (0, sanitizer_1.createSanitizer)();

 ...
 */
export function calculateL1Completion(l1Data) {
    const fields = Object.keys(L1_FIELD_WEIGHTS);
...
export function getMissingFieldLabels(missingFields) {
    return missingFields.map(field => L1_FIELD_LABELS[field] || String(field));
}
/**

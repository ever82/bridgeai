 ...
 */
export function calculateCompositeScore(agent) {
 ...
 */
export function calculateActivityScore(agent) {
 ...
 * Sort by rating
 */
function sortByRating(a, b, order) {
 ...
 * Sort by experience
 */
function sortByExperience(a, b, order) {
 ...
 * Sort by activity
 */
function sortByActivity(a, b, order) {
 ...
 */
function sortByCredit(a, b, order) {
 ...
 */
function sortByComposite(a, b, order) {
 ...
 */
export function sortAgents(results, strategy, order = 'desc') {
 ...
 */
export function sortRawAgents(agents, strategy, order = 'desc') {
 ...
 */
export function areAgentsEqual(a, b) {
    return a.id === b.id;
}
/**
 * Check if sorting produces stable results
 */
export function isStableSort(results) {

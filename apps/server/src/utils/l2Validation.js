 ...
 */
export function validateL2Data(data, schema) {
    const errors = [];
 ...
 */
function validateField(value, field, allData) {
    const errors = [];
 ...
 */
export function getFieldValueLabel(field, value) {
 ...
 */
export function getVisibleFields(schema, data) {
 ...
 */
export function calculateL2Completion(data, schema) {
...
//# sourceMappingURL=l2Validation.js.map
...
// ---------------------------------------------------------------------------
// Types (mirrors SensitiveLevel from Prisma)
// ---------------------------------------------------------------------------
 ...
 */
export const DEFAULT_SENSITIVE_WORDS: readonly DefaultSensitiveWord[] = [
...
// ---------------------------------------------------------------------------
// Default regex patterns for complex matching
// ---------------------------------------------------------------------------
 ...
 */
export const DEFAULT_REGEX_PATTERNS: readonly DefaultRegexPattern[] = [
 ...
 */
export const SENSITIVE_WORD_CATEGORIES: readonly SensitiveWordCategory[] = [

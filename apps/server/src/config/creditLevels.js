...
// 等级分数区间
export const CREDIT_LEVEL_RANGES = {
...
// 等级权益配置
export const CREDIT_LEVEL_BENEFITS = [
    {
...
export function getCreditLevel(score) {
    ...
    if (score >= 600)
        return CreditLevel.GENERAL;
    return CreditLevel.POOR;
}
// 根据等级获取配置
export function getCreditLevelConfig(level) {
...
//# sourceMappingURL=creditLevels.js.map
...
async function main() {
    ...
    const scenes = await Promise.all([
        prisma.scene.create({
            data: {
                code: client_1.SceneCode.VISION_SHARE,
                name: 'VisionShare',
        ...
        prisma.scene.create({
            data: {
                code: client_1.SceneCode.AGENT_DATE,
                name: 'AgentDate',
        ...
        prisma.scene.create({
            data: {
                code: client_1.SceneCode.AGENT_JOB,
                name: 'AgentJob',
        ...
        prisma.scene.create({
            data: {
                code: client_1.SceneCode.AGENT_AD,
                name: 'AgentAd',
        ...
        for (const scene of scenes) {
            await prisma.agentProfile.create({
                data: {
                    ...
                    sceneConfig: {
                        filters: {
                            distance: scene.code === client_1.SceneCode.VISION_SHARE ? 1000 : 50000,
                            minCredit: 60,
                        },
                    },
                    isActive: true,
    ...
    const messages = await Promise.all([
        ...
        prisma.chatMessage.create({
            data: {
                ...
                senderType: client_1.SenderType.AGENT,

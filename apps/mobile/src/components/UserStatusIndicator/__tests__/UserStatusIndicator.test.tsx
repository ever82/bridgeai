...
describe('UserStatusIndicator', () => {
  ...
  describe('Presence', () => {
    ...
    it('subscribes to user presence on mount', () => {
      render(<UserStatusIndicator userId="user-1" senderType={SenderType.AGENT} showPresence />);
    ...
    it('unsubscribes on unmount', () => {
      const { unmount } = render(
        <UserStatusIndicator userId="user-1" senderType={SenderType.AGENT} showPresence />
      );

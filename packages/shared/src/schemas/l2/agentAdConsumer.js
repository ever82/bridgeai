...
exports.agentAdConsumerL2Schema = void 0;
 ...
 * 用于消费者配置购买需求，匹配商家
 */
exports.agentAdConsumerL2Schema = {
    ...
    fields: [
        ...
        {
            id: 'budgetMin',
            type: types_1.L2FieldType.NUMBER,
            label: '最低预算',
        ...
        {
            id: 'anyBrand',
            type: types_1.L2FieldType.BOOLEAN,
            label: '接受任何品牌',
...
exports.default = exports.agentAdConsumerL2Schema;
